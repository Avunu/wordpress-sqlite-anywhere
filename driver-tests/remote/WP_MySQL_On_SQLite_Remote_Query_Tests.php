...
require_once __DIR__ . '/../WP_MySQL_On_SQLite_Query_Tests.php';

/**
 * Upstream's WP_MySQL_On_SQLite_Query_Tests against the selected remote backend.
 *
 ...
 */
class WP_MySQL_On_SQLite_Remote_Query_Tests extends WP_MySQL_On_SQLite_Query_Tests {
